...
###### BUILD CLASSIFIER ######
def create_classifiers(params_dict):
    return None
...
def run_models(x_train, x_test, y_train, y_test,models_to_run='all'):
    ...
    clfs, grid = ml_helper_functions.define_clfs_params()
    ...
    for index,clf in enumerate([clfs[x] for x in models_to_run]):
        ...
        for p in ParameterGrid(parameter_values):
                ...
                ml_helper_functions.precision_at_k(y_test,pred_probs, 100),
                ml_helper_functions.precision_at_k(y_test,pred_probs, 5),
                ml_helper_functions.precision_at_k(y_test,pred_probs, 10),
                ml_helper_functions.precision_at_k(y_test,pred_probs, 20),
                ml_helper_functions.precision_at_k(y_test,pred_probs, 30),
                ml_helper_functions.precision_at_k(y_test,pred_probs, 40),
                ml_helper_functions.precision_at_k(y_test,pred_probs, 50),
                ml_helper_functions.recall_at_k(y_test,pred_probs, 5),
                ml_helper_functions.recall_at_k(y_test,pred_probs, 10),
                ml_helper_functions.recall_at_k(y_test,pred_probs, 20),
                ml_helper_functions.recall_at_k(y_test,pred_probs, 30),
                ml_helper_functions.recall_at_k(y_test,pred_probs, 40),
                ml_helper_functions.recall_at_k(y_test,pred_probs, 50),
